...
<%@page import='br.com.testeJpaHibernate.core.dominio.*'%>
...
<html>
	...
	<body>
		...
		<legend align="center">Formulário do Aluno</legend>
			<form class="form_form" action="http://localhost:8080/teste_jpa_hibernate/aluno">
			...
			<!-- Consultar -->
			<form class="form" action="http://localhost:8080/teste_jpa_hibernate/aluno">
				<!-- Botões CRUD -->
	  ...
	  <footer class="py-5 bg-dark">
	    <div class="container">
	      <p class="m-0 text-center text-white">Copyright &copy; Teste JPA com Hibernate 2022</p>
	    </div>
	  </footer>
  	  <!-- Fim Footer -->
